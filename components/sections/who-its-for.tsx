    ...
    <section className="bg-white py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-[#94a3b8] font-light">Built for modern students</p>
        </motion.div>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {cards.map((card, index) => (
            <motion.div
              ...
              className="flex flex-col overflow-hidden rounded-xl border border-[#e2e8f0] bg-white p-2 shadow-sm transition-shadow hover:shadow-md"
            >
              {/* Image Container */}
              ...
              <div className="px-6 py-8 text-center">
                <h3 className="mb-4 text-xl font-bold text-[#4a5568]">
                  {card.title}
                </h3>
                <p className="text-base leading-relaxed text-[#718096]">
                  {card.description}
                </p>
              </div>
            </motion.div>
